...
/**
 * An Android io.flutter.view containing a Flutter app.
 */
public class FlutterView extends SurfaceView
    ...
    public interface Provider {
        /**
         * Returns a reference to the Flutter io.flutter.view maintained by this object. This may
         * be {@code null}.
         */
        io.flutter.view.FlutterView getFlutterView();
    }
    ...
    void assertAttached() {
        if (!isAttached())
            throw new AssertionError("Platform io.flutter.view is not attached");
    }
    ...
    protected void dispatchSemanticsAction(int id, io.flutter.view.AccessibilityBridge.Action action) {
    ...
    public void send(String channel, ByteBuffer message, BinaryReply callback) {
        if (!isAttached()) {
            Log.d(TAG, "FlutterView.send called on a detached io.flutter.view, channel=" + channel);
            return;
        }
